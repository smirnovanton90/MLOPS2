...
f_input = sys.argv[1]
f_output_train = os.path.join("datasets", "stage5", "train.csv")
os.makedirs(os.path.join("datasets", "stage5"), exist_ok = True)
f_output_test = os.path.join("datasets", "stage5", "test.csv")
os.makedirs(os.path.join("datasets", "stage5"), exist_ok = True)
